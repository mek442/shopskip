...
public class MailSenderServiceImpl implements MailSenderService {
    ...
    private static com.skip.util.log.Logger LOG = LogService.getLogger(MailSenderServiceImpl.class);
    ...
    private EmailServiceTokenModel sendVerificationEmail(final EmailServiceTokenModel emailVerificationModel, final String emailSubject,
        ...
        LOG.debug(String.format("Sending { %s} token to : { %s }",emailVerificationModel.getTokenType().toString(), emailVerificationModel.getEmailAddress()));
