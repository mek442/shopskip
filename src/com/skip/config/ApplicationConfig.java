...
public class ApplicationConfig {
    ...
    private final static String SECURITY_ENCRYPTPASSWORD= "security.encryptPassword";
    private final static String SECURITY_ENCRYPTSALT="security.encryptSalt";
    ...
    public String getEncryptionPassword(){
    	return environment.getProperty(SECURITY_ENCRYPTPASSWORD);
    }
    
    public String getEncryptionSalt(){
    	return environment.getProperty(SECURITY_ENCRYPTSALT);
    }
}
